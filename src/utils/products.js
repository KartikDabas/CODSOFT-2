...
export const SliderData = [
  {
      ...
      desc: "Get ready for crazy discounts. Keep wishlisting!",
      cover: sofaSlide,
  },
  {
      id: 2,
  ...
  {
      id: 3,
      title: "Super value deals on all products",
      desc: "Save more with coupons & upto 70% off!",
      cover: wireless01,
  },
  {
      id: 4,
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "No minimums! No coupons required!",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "24/7 support",
    subtitle: "Get 24/7 help and support from us.",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Return policy",
    subtitle: "Easy return if problem found!",
    bg: "#e2f2b2",
  },
  {
